	...
	<section style="height:100%;overflow:hidden;">
		...
		<el-card>
			...
			>
				...
				<el-table-column prop="OutDate" label="入库日期" align="center" :formatter="dataFormatter" min-width="100px" sortable> </el-table-column>
				<el-table-column prop="Provider" label="供应商" align="center"></el-table-column>
				<el-table-column prop="InDate" label="进货日期" align="center" :formatter="dataFormatter" min-width="100px" >
				</el-table-column>
