  ...
  <section>
          ...
          <el-collapse-item name="search" class="coll">
            ...
            >
              ...
              <el-form-item label="供货商">
                <el-input placeholder="请输入供货商" v-model="keyword" clearable></el-input>
              </el-form-item>
            </el-form>
            <el-col :span="24" style="text-align: center;margin-top: 20px;" class="btns">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="showRemarkFormDialogVisible = false">确定添加</el-button>
      </span>
    </el-dialog>
  </section>
</template>
