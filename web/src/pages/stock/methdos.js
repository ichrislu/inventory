...
export default {
	...
	// toTableTop() {
	// 	setInterval(() => {
	// 		var top = this.$refs.table.bodyWrapper.scrollTop
	// 		var speed = top / 4
	// 		if (this.$refs.table.bodyWrapper.scrollTop != 0) {
	// 			this.$refs.table.bodyWrapper.scrollTop -= speed
	// 		} else {
	// 			this.$refs.table.bodyWrapper.scrollTop -= speed
	// 		}
	// 		if (top == 0) {
	// 			// clearInterval(this.toTableTop)
	// 			// console.log('已清除')
	// 			return
	// 		}
	// 		// _this.$refs.table.bodyWrapper.scrollTop = 0;
	// 		// _this.$refs.table.bodyWrapper.scrollLeft = 0;
	// 	}, 40)
	// },
